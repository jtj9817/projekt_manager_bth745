...
class Project(models.Model):
    ...
    project_time = models.models.DateTimeField(_(""), auto_now=False, auto_now_add=False)
    proj_created_at = models.DateTimeField(auto_now_add=True)
    proj_deadline = models.DateFimeField(required=True)
	def __str__(self):
...
class Task(models.Model):
    ...
    task_priority = mmodels.PositiveIntegerField(choices=TASK_PRIORITY, default=1)
